...
class TestCalculateBalance:
    ...
    def test_simple_bill_split_with_tax_and_service_charge__discounted_amount_paid(self):
    ...
    def test_multiple_bills_with_different_service_charges_and_no_tax__discounted_amount_paid(self):
        outing = Outing(
            bills=[
                Bill(
                    paid_by="alice",
